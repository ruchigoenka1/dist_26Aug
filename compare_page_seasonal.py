...
if uploaded_file is not None:
    try:
        ...
        for i in range(len(actual_dates) - 1):
            start_date = actual_dates[i]
            end_date = actual_dates[i+1]
            stitched_dates.append(start_date)
        ...
        cov_demand = std_demand_hist / avg_demand_hist if avg_demand_hist > 0 else 0
        ...
        d2.metric("Demand Std Dev", round(std_demand_hist, 1))
        ...
        fig1.add_hrect(y0=0, y1=ref_line*0.5, fillcolor="red", opacity=0.1)
